...
- [anti-slop-design](https://github.com/wwewtech/anti-slop-design) - Open-source design engineering skill that cures vibe-coded prototypes from AI frontend slop using curated token archetypes and tactile micro-states.
